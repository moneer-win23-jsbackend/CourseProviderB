using Azure.Core;
using CourseProviderB.Infrastructure.Data.Entities;
using CourseProviderB.Infrastructure.GraphQL;
using CourseProviderB.Infrastructure.Models;

namespace CourseProviderB.Infrastructure.Factories;
    ...
    public static Course Create(CourseEntity entity)
    {
        return new Course
        {
            ...
            Content = entity.Content == null ? null : new Content
            {
                ...
                ProgramDetails = entity.Content.ProgramDetails?.Select(pd => new ProgramDetailItemCreateRequest
                {
                    Id = pd.Id,
                    Title = pd.Title,
                    Description = pd.Description
